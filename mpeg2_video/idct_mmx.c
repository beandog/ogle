...
/*
 * 2001-10-17 hh
 * Modified sligtly to fit better with Ogle (s/ATTR_ALIGN/ATTRIBUTE_ALIGNED/).
 * Removed unneeded and '#if 0':ed parts.
 */
...
#define C4 23170
    ...
    static short _T1[] ATTRIBUTE_ALIGNED(8) = {T1,T1,T1,T1};
    static short _T2[] ATTRIBUTE_ALIGNED(8) = {T2,T2,T2,T2};
    static short _T3[] ATTRIBUTE_ALIGNED(8) = {T3,T3,T3,T3};
    static short _C4[] ATTRIBUTE_ALIGNED(8) = {C4,C4,C4,C4};
...
static int32_t rounder0[] ATTRIBUTE_ALIGNED(8) =
    rounder ((1 << (COL_SHIFT - 1)) - 0.5);
static int32_t rounder4[] ATTRIBUTE_ALIGNED(8) = rounder (0);
static int32_t rounder1[] ATTRIBUTE_ALIGNED(8) =
    rounder (1.25683487303);	/* C1*(C1/C4+C1+C7)/2 */
static int32_t rounder7[] ATTRIBUTE_ALIGNED(8) =
    rounder (-0.25);		/* C1*(C7/C4+C7-C1)/2 */
static int32_t rounder2[] ATTRIBUTE_ALIGNED(8) =
    rounder (0.60355339059);	/* C2 * (C6+C2)/2 */
static int32_t rounder6[] ATTRIBUTE_ALIGNED(8) =
    rounder (-0.25);		/* C2 * (C6-C2)/2 */
static int32_t rounder3[] ATTRIBUTE_ALIGNED(8) =
    rounder (0.087788325588);	/* C3*(-C3/C4+C3+C5)/2 */
static int32_t rounder5[] ATTRIBUTE_ALIGNED(8) =
...
{									\
    static int16_t table04[] ATTRIBUTE_ALIGNED(16) =			\
	table (22725, 21407, 19266, 16384, 12873,  8867, 4520);		\
    static int16_t table17[] ATTRIBUTE_ALIGNED(16) =			\
	table (31521, 29692, 26722, 22725, 17855, 12299, 6270);		\
    static int16_t table26[] ATTRIBUTE_ALIGNED(16) =			\
	table (29692, 27969, 25172, 21407, 16819, 11585, 5906);		\
    static int16_t table35[] ATTRIBUTE_ALIGNED(16) =			\
